...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pytravisci-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14410&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pytravisci-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pytravisci` can be installed with:

```
conda install pytravisci
```

It is possible to list all of the versions of `pytravisci` available on your platform with:
